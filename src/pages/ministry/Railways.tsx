...
export default function Railways() {
  const ministry = getMinistryData('railways');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                ...
                <span className="font-semibold">Train Status</span>
              </div>
              <p className="text-gray-600">Check live running status</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                ...
                <span className="font-semibold">Train Schedule</span>
              </div>
              <p className="text-gray-600">View time tables</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Travel safety information</p>
            </button>
          </div>
        </div>
      </div>
