...
export default function Health() {
  const ministry = getMinistryData('health');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                ...
                <span className="font-semibold">Ayushman Card</span>
              </div>
              <p className="text-gray-600">Check eligibility & apply</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Locate nearby facilities</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Access medical records</p>
            </button>

            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                <AlertCircle className="h-6 w-6 mr-2" />
                <span className="font-semibold">Health Advisory</span>
              </div>
              <p className="text-gray-600">Latest health guidelines</p>
            </button>
          </div>
        </div>
      </div>
