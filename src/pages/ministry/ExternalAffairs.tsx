...
export default function ExternalAffairs() {
  const ministry = getMinistryData('external-affairs');
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Latest updates and safety information</p>
            </button>

            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                <Building className="h-6 w-6 mr-2" />
                <span className="font-semibold">Find an Embassy</span>
              </div>
              <p className="text-gray-600">Locate Indian missions worldwide</p>
            </button>

            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                <Users className="h-6 w-6 mr-2" />
                <span className="font-semibold">Consular Services</span>
              </div>
              <p className="text-gray-600">Access various consular services</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Important websites and resources</p>
            </button>
          </div>
        </div>
      </div>
