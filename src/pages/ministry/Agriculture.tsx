...
export default function Agriculture() {
  const ministry = getMinistryData('agriculture');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                ...
                <span className="font-semibold">PM-KISAN Status</span>
              </div>
              <p className="text-gray-600">Check benefit status</p>
            </button>

            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                <Shield className="h-6 w-6 mr-2" />
                <span className="font-semibold">Crop Insurance</span>
              </div>
              <p className="text-gray-600">Apply for PMFBY</p>
            </button>

            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              <div className="flex items-center text-orange-600 mb-3">
                <Droplets className="h-6 w-6 mr-2" />
                <span className="font-semibold">Irrigation Status</span>
              </div>
              <p className="text-gray-600">Check water availability</p>
            </button>
            ...
            <button className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left">
              ...
              <p className="text-gray-600">Agricultural advisories</p>
            </button>
          </div>
        </div>
      </div>
